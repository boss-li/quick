...
struct  Bbr2Params {
  ...
  QuicTime::Delta probe_bw_probe_base_duration =
	  QuicTime::Delta::FromMilliseconds(2000);
  ...
  QuicTime::Delta probe_rtt_period = QuicTime::Delta::FromMilliseconds(10000);
  ...
  float inflight_hi_headroom = 0.00999999978;

  // Estimate startup/bw probing has gone too far if loss rate exceeds this.
  float loss_threshold = 0.300000012;
